...
# Right side — today's topic dominant; last week's talk demoted to a small reference
add_text(s, Inches(5.4), Inches(1.9), Inches(7.5), Inches(0.4),
         "REPLY TO LAST WEEK", size=11, bold=True, color=GREY_CTX)
add_text(s, Inches(5.4), Inches(2.3), Inches(7.5), Inches(0.5),
         "“How Climate Change Affects the World We Live In”",
         size=13, color=TEXT_MUTED)
add_text(s, Inches(5.4), Inches(3.1), Inches(7.5), Inches(1.0),
         "Today: the other half of the story.",
         size=28, color=TEXT, bold=True)
add_text(s, Inches(5.4), Inches(4.0), Inches(7.5), Inches(0.8),
         "Why cutting fossil fuels now can cost\nmore lives than it saves.",
         size=15, color=TEXT_MUTED)
add_text(s, Inches(5.4), Inches(5.1), Inches(7.5), Inches(0.5),
         "Choolwe", size=22, bold=True, color=BLUE)
add_text(s, Inches(5.4), Inches(5.65), Inches(7.5), Inches(0.4),
...
# Three iconographic cards (coal / oil / gas) — mirrors the Situation slide rhythm
primer_cards = [
    (icon_globe, "Coal",
...
# =========================================================================
# Slide 5 — Complication 1: deaths we don't count (waffle)
# =========================================================================
s = prs.slides.add_slide(BLANK)
...
# =========================================================================
# Slide 6 — Complication 2: justice asymmetry (isotype)
# =========================================================================
s = prs.slides.add_slide(BLANK)
...
# =========================================================================
# Slide 7 — Complication 3: Zambia 24-hour clock
# =========================================================================
s = prs.slides.add_slide(BLANK)
add_top_bar(s, color=AMBER)
...
# =========================================================================
# Slide 10 — Sources (dedicated appendix, no per-slide footers)
# =========================================================================
s = prs.slides.add_slide(BLANK)
add_top_bar(s, color=BLUE)
