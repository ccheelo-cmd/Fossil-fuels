"""Build the 'Case For Fossil Fuels' .pptx — reliability spine (main deck).

Output: case-for-fossil-fuels.pptx (repo root)
Earlier versions are archived under versions/.
...
# =========================================================================
# Save — main deck at repo root
# =========================================================================
out = HERE / "case-for-fossil-fuels.pptx"
prs.save(out)
print(f"wrote {out}")
